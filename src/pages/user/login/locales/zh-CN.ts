export default {
  'user-login.login.usercode': '用户名',
  'user-login.login.password': '密码',
  'user-login.login.message-invalid-code-2': '账户或密码错误',
  'user-login.login.message-invalid-code-3': '账户或密码错误',
  'user-login.login.message-invalid-code-1': '验证码错误',
  'user-login.login.message-invalid-code-4': '当前用户名已被锁定,无法登录!',
  ...
  'user-login.usercode.required': '请输入用户名!',
  ...
  'user-login.verification-code.max4': '请输入4位验证码！',
